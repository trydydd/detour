...
This project ships a container image for running detour with Claude Code. See `docs/docker.md` for usage documentation. The Docker build tasks are tracked in `work-ledger-docker.yaml`.
